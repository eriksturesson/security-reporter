...
exports.getExitCode = exports.reportToMarkdown = exports.reportToJson = exports.reportToTerminal = void 0;
/**
 * Format and display validation report in terminal with beautiful output
 */
const reportToTerminal = (report) => {
    const professional = process.env.SECURITY_REPORT_PROFESSIONAL === "1" || process.env.SECURITY_REPORT_PROFESSIONAL === "true";
    const showDetails = process.env.SECURITY_REPORT_SHOW_DETAILS === "1" || process.env.SECURITY_REPORT_SHOW_DETAILS === "true";
    const iconOrText = (icon, text) => (professional ? text : icon);
    const width = 80;
    ...
    const patternsChecked = secretsCheck && typeof secretsCheck.details === "object"
        ? secretsCheck.details.patternsChecked || secretsCheck.details.filesScanned || undefined
        : undefined;
    const filesScanned = secretsCheck && typeof secretsCheck.details === "object" ? secretsCheck.details.filesScanned : undefined;
    const summaryItems = [
    ...
    if (professional) {
        const text = report.overallStatus === "fail"
...
const displayCheckDetailed = (check, options) => {
    ...
    const showDetails = (_b = options === null || options === void 0 ? void 0 : options.showDetails) !== null && _b !== void 0 ? _b : false;
 ...
 */
const displayCheckCompact = (check, options) => {
    var _a, _b;
    const professional = (_a = options === null || options === void 0 ? void 0 : options.professional) !== null && _a !== void 0 ? _a : false;
    const showDetails = (_b = options === null || options === void 0 ? void 0 : options.showDetails) !== null && _b !== void 0 ? _b : false;
 ...
 */
const getOverallStatusDisplay = (status) => {
    switch (status) {
        case "fail":
